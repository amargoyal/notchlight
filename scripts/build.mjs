...
const targets = [
  ...
  {
    ...web,
    entryPoints: [path.join(root, 'src/renderer/island.tsx'), path.join(root, 'src/renderer/gallery.tsx'), path.join(root, 'src/renderer/customize.tsx'), path.join(root, 'src/renderer/update.tsx'), path.join(root, 'src/renderer/welcome.tsx')],
...
for (const f of ['island.html', 'gallery.html', 'customize.html', 'update.html', 'welcome.html']) {
